...
public class VaultUtils {
    public static void storeItems(List<ItemStack> items, Player p){
        ...
        if (items.size() == 0){
            data.set(new NamespacedKey(WildCore.getPlugin(), "vault"), PersistentDataType.STRING, "");
        }else{
            ...
            try{
                ...
                data.set(new NamespacedKey(WildCore.getPlugin(), "vault"), PersistentDataType.STRING, encodedData);
    ...
    public static ArrayList<ItemStack> getItems(Player p){
        ...
        String encodedItems = data.get(new NamespacedKey(WildCore.getPlugin(), "vault"), PersistentDataType.STRING);
